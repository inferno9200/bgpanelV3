...
if (isset($_GET['task']))
{
	$task = mysqli_real_escape_string($_GET['task']);
}
				...
				<div class="span4 offset4">
					<div class="well">
						...
						<input type="hidden" name="task" value="processpassword" />
							...
							<button class="btn btn-inverse" type="button" onclick="document.getElementById('captcha').src = '../captcha/securimage_show.php?' + Math.random(); return false"><i class="icon-retweet icon-white"></i></button>
							<label></label>
							<div class="input-prepend">
